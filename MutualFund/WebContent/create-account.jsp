...
<script type="text/javascript">
	$(document).ready(
			function() {
				var subject1 = [ 'Alabama', 'Alaska', 'Arizona', 'Arkansas',
						'California', 'Colorado', 'Connecticut', 'Delaware',
						'Florida', 'Georgia', 'Hawaii', 'Idaho', 'Illinois',
						'Indiana', 'Iowa', 'Kansas', 'Kentucky', 'Louislana',
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="userName" id="inputUsername"
				placeholder="Username" value="${ form.userName }"> <span
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="password" name="confirmPassword"
				id="inputConfirmPassword" placeholder="Confirm Password"> <span
				style="color: red">*</span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="firstName" id="inputFirstName"
				placeholder="First Name" value="${ form.firstName }"> <span
				style="color: red">*</span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="lastName" id="inputLastName"
				placeholder="Last Name" value="${ form.lastName }"> <span
				style="color: red">*</span>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="inputAddrLine1">Address Line
			1</label>
		<div class="controls">
			<input type="text" name="addrLine1" id="inputAddrLine1"
				placeholder="Address Line 1" value="${ form.addrLine1 }"> <span
				style="color: red">*</span>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="inputAddrLine2">Address Line
			2</label>
		<div class="controls">
			<input type="text" name="addrLine2" id="inputAddrLine2"
				placeholder="Address Line 2" value="${ form.addrLine2 }">
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="city" id="inputCity" placeholder="City"
				value="${ form.city }"> <span style="color: red">*</span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="state" id="inputState" placeholder="State"
				value="${ form.state }"> <span style="color: red">*</span>
		</div>
	</div>
	<div class="control-group">

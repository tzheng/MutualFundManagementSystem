...
public class EmployeeDAO extends BaseDAO {
	...
	public EmployeeDAO(String jdbcDriver, String jdbcURL, String tableName)
	...
	public synchronized void changePassword(String username, String newPassword) {
		...
		try {
			...
			PreparedStatement pstmt = con.prepareStatement("UPDATE "
					+ tableName + " SET password=? , salt=? WHERE userName=?");
	...
	public void createTable() throws MyDAOException {
		...
		try {
			...
			stmt.executeUpdate("CREATE TABLE " + tableName
					...
					+ "salt INT(11) DEFAULT 0 ," + "PRIMARY KEY (userName) );");
			stmt.close();
			...
			stmt.executeUpdate("INSERT INTO "
					+ tableName
					+ " (username, password, firstName, lastName, salt) VALUES ('admin', '"
					+ employee.getPassword() + "', 'admin', 'admin', "
					+ employee.getSalt() + ")");
			stmt.close();

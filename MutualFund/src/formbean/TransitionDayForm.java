	...
	public List<String> getValidationErrors() {
        ...
        for (int i = 0; i < fundId.length; i++) {
        	...
        	try {
    			...
    			if (temp < 0.01 || temp > Math.pow(10, 5)) 
    				throw new IllegalArgumentException("The " + count + "th closing price is not an number between 0.01 dollar and 100,000.00 dollars");
    		} catch (NumberFormatException e) {
